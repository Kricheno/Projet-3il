...
class PowerShellCommandProcessor implements Callable<String> {
    ...
    public String call() throws InterruptedException {
        ...
        try {
            ...
            Logger.getLogger(com.example.projet.api.wmi.PowerShell.class.getName()).log(Level.SEVERE, "Unexpected error reading PowerShell output", ioe);
    ...
    private void readData(StringBuilder powerShellOutput) throws IOException {
        ...
        while (null != (line = this.reader.readLine())) {
            ...
            if (this.scriptMode) {
                if (line.equals(com.example.projet.api.wmi.PowerShell.END_SCRIPT_STRING)) {
                    break;
                }
            }
