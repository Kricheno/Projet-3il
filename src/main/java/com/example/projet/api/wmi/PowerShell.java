...
public class PowerShell implements AutoCloseable {
        ...
        try {
            this.waitPause = Integer
                    .valueOf((config != null && config.get("waitPause") != null) ? config.get("waitPause")
                            : com.example.projet.api.wmi.PowerShellConfig.getConfig().getProperty("waitPause"));
            this.maxWait = Long.valueOf((config != null && config.get("maxWait") != null) ? config.get("maxWait")
                    : com.example.projet.api.wmi.PowerShellConfig.getConfig().getProperty("maxWait"));
            this.tempFolder = (config != null && config.get("tempFolder") != null) ? getTempFolder(config.get("tempFolder"))
                    : getTempFolder(com.example.projet.api.wmi.PowerShellConfig.getConfig().getProperty("tempFolder"));
     ...
     * @throws com.example.projet.api.wmi.PowerShellNotAvailableException if PowerShell is not installed in the system
     */
    public static PowerShell openSession() throws com.example.projet.api.wmi.PowerShellNotAvailableException {
     ...
     * @throws com.example.projet.api.wmi.PowerShellNotAvailableException if PowerShell is not installed in the system
     */
    public static PowerShell openSession(String customPowerShellExecutablePath) throws com.example.projet.api.wmi.PowerShellNotAvailableException {
    ...
    private PowerShell initalize(String powerShellExecutablePath) throws com.example.projet.api.wmi.PowerShellNotAvailableException {
        ...
        try {
            ...
            if (p.waitFor(5, TimeUnit.SECONDS) && !p.isAlive()) {
                throw new com.example.projet.api.wmi.PowerShellNotAvailableException(
    ...
    public static PowerShellResponse executeSingleCommand(String command) {
        ...
        } catch (com.example.projet.api.wmi.PowerShellNotAvailableException ex) {
